...
def arrays_w(w,karray,epsilon=10**(-10),nd=200):
    kmin = np.amin(karray)
    power= 10
    w    = vv(w)
    smax = 10/kmin
...
def arrays_1(w,karray,epsilon=10**(-10),nd=200):
    kmin = np.amin(karray)
    power= 4
    w    = vv(w)
    smax = 10/kmin
    if floor(smax)<800:
        ...
        ns0 = floor(1600+np.sqrt(smax-800))
    d  =  np.linspace(0,1-epsilon,nd)
    dd =  np.repeat(d,ns0)
...
def arrays_r(karray,epsilon=10**(-10),nd=200):
    kmin = np.amin(karray)
    power= 10
    smax = 10/kmin
    ns1  = 400
