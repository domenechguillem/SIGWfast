...
data = np.load('data/OmegaGW_of_k_BPL_nuv5_w1_precise.npz')
lst=data.files
...
data = np.load('data/OmegaGW_of_k_BPL_nuv5_w23_precise.npz')
lst=data.files
...
data = np.load('data/OmegaGW_of_k_BPL_nuv5_w19_precise.npz')
lst=data.files
...
data = np.load('data/OmegaGW_of_k_BPL_nuv5_w13_precise.npz')
lst=data.files
...
plt.plot(krange001,OMEGA001,lw=2,color="blue",label="$w=2/3$")
...
plt.savefig("plots/GW_spectrum_BPL.pdf", format='pdf',transparent=True)
...
plt.plot(krange01nolog,OMEGA01der,lw=2,color="green",label="$w=1/3$")
plt.plot(krange005nolog,OMEGA005der,lw=2,color="red",label="$w=1/9$")
plt.plot(krange001nolog,OMEGA001der,lw=2,color="blue",label="$w=2/3$")
...
plt.savefig("plots/GW_spectrum_der_BPL.pdf", format='pdf',transparent=True)
